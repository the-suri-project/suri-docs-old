import{_ as t,o as e,c as o,e as a}from"./app.36728e2d.js";const n={},c=a(`<h1 id="record-format" tabindex="-1"><a class="header-anchor" href="#record-format" aria-hidden="true">#</a> Record Format</h1><p>Records have only one canonical format for their definitions, consisting of a suri in its <a href="/domains/formats#canonical-format">canonical format</a> followed by a colon <code>:</code> and a stack of protocols along with their arguments:</p><div class="language-text ext-text"><pre class="language-text"><code>suri.domains:http&lt;tcp(80)&lt;ipv4(127.0.0.1)
\u2500\u252C\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500 \u2500\u252C\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500
 \u2514\u25BASuri       \u2514\u25BAProtocol stack
</code></pre></div><p>The protocols are expressed by indicating the highest level first to facilitate the search process. Moreover, each protocol is followed by an optional argument in parentheses in case the protocol needs it.</p><div class="language-text ext-text"><pre class="language-text"><code>                   Protocol level
             + \u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u25BA -
...
</code></pre></div><div class="custom-container note"><p class="custom-container-title">Insight</p><p>The signature does not need to be unique.</p></div>`,12),r=[c];function i(l,s){return e(),o("div",null,r)}const p=t(n,[["render",i],["__file","format.html.vue"]]);export{p as default};
